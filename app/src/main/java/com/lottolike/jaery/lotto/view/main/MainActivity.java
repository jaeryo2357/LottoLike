...
public class MainActivity extends AppCompatActivity {
    ...
    public void InsertRecommend(){
        ...
        HashMap<String,String> temp = LottoItem.GetNumber(getApplicationContext(),sharedPreferences.getLottoNumber());
        ...
        if(temp.size()>0)
        {
            ...
            db.open();
            db.MyListInsert(sharedPreferences.getRecommend(),
                    gregorianCalendar.get(Calendar.YEAR)+"-"+(gregorianCalendar.get(Calendar.MONTH)+1)+"-"+gregorianCalendar.get(Calendar.DAY_OF_MONTH),
                    sharedPreferences.getLottoNumber()+1);
        }
    }
